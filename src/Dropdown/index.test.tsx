...
test('renders dropdown', () => {
  const checkbox = shallow(<Dropdown opened button={<div>test</div>}>test</Dropdown>)
  expect(checkbox).toMatchSnapshot()
})

test('passing checked prop as true should show dropdown content', () => {
  const dropdown = mount(<Dropdown opened button={<div>test</div>}>test</Dropdown>)
...
test('passing checked prop as false should hide dropdown content', () => {
  const dropdown = mount(<Dropdown opened={false} button={<div>test</div>}>test</Dropdown>)
